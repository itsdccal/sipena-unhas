    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.degrees.update', $degree) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text"
                                name="degree_code"
                                id="degree_code"
                                value="{{ old('degree_code', $degree->degree_code) }}"
                                required
                        ...
                        <div>
                            ...
                            <input type="text"
                                name="degree_name"
                                id="degree_name"
                                value="{{ old('degree_name', $degree->degree_name) }}"
                                required
