    ...
    <div class="inline-flex rounded-md shadow-xs mb-5 shadow-sm" role="group">
        ...
        <a href="{{ route('admin.study-programs.index') }}" class="px-4 py-2 text-sm font-medium cursor-pointer rounded-e-lg text-gray-500 bg-gray-200 border border-gray-200  hover:bg-white hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200 mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.degrees.index') }}" class="grid grid-cols-1 md:grid-cols-1 gap-4">
                        <!-- Search -->
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah program Studi</th>
