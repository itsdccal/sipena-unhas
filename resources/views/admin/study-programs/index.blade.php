<x-app-layout>
    ...
    <div class="inline-flex rounded-md shadow-xs mb-5 shadow-sm" role="group">
        ...
        <a href="{{ route('admin.degrees.index') }}" class="px-4 py-2 text-sm font-medium cursor-pointer text-gray-500 bg-gray-200 border border-gray-200  hover:bg-white hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
            Jenjang
            </a>
        <a href="{{ route('admin.study-programs.index') }}" class="px-4 py-2 text-sm font-medium rounded-e-lg cursor-pointer text-blue-700 bg-white border border-gray-200  hover:bg-white hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
        Program Studi
        </a>
                    ...
                    <form method="GET" action="{{ route('admin.study-programs.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="search" name="search" value="{{ request('search') }}"
                                placeholder="Cari berdasarkan kode dan nama program studi ..."
                        ...
                        <!-- Degree Filter -->
                        <div>
                            <label for="degree" class="block text-sm font-medium text-gray-700 mb-2">Jenjang</label>
