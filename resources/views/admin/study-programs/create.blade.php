                    ...
                    <form method="POST" action="{{ route('admin.study-programs.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                value="{{ old('sp_code') }}"
                                required
                                placeholder="contoh: KED-001"
                                maxlength="10"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('sp_code') @enderror">
                            @error('sp_code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Kode unik untuk program studi ini (maksimal 10 karakter)</p>
                        </div>
